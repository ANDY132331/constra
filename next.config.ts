...
const securityHeaders = [
  ...
  { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://*.supabase.co https://images.unsplash.com https://server.arcgisonline.com",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.open-meteo.com https://geocoding-api.open-meteo.com https://vitals.vercel-insights.com https://nominatim.openstreetmap.org https://api.groq.com",
      "font-src 'self'",
      "media-src 'self' blob:",
