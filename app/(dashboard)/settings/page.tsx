...
function SettingsInner() {
  ...
  const enableNotifs = async () => {
    ...
    if (result === "granted" && companyId && currentUser.id) {
      subscribeToPush(companyId, currentUser.id).catch((err) => {
            ...
            <div className="bg-[#111111] border border-white/[0.06] rounded-2xl p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input className={inp} value={companyForm.name} placeholder="Your company name" maxLength={100}
                    onChange={(e) => setCompanyForm((f) => ({ ...f, name: e.target.value }))} />
                </div>
                <div>
                  <label className={lbl}>Business / Tax Number</label>
                  <input className={inp} value={companyForm.businessNumber} placeholder="e.g. 123456789" maxLength={30}
                ...
                <div className="col-span-2">
                  ...
                  <input className={inp} value={companyForm.address} placeholder="Street, City, Province, Postal Code" maxLength={200}
