...
export default function PrivacyPage() {
  const sections = [
    ...
    },
    {
      ...
      body: `We use collected information to: (a) provide and improve the Service; (b) authenticate users and secure your account; (c) generate reports, invoices, and payroll exports as requested; (d) communicate with you about your account or the Service; (e) send push notifications you have explicitly opted into; and (f) comply with legal obligations. We do not use your data for advertising or marketing to third parties.`,
    },
    {
      title: "4. Push Notifications",
      body: `If you grant notification permission, Constra uses the Web Push API to deliver real-time alerts (such as crew clock-in events) to your browser or installed PWA. Your push subscription token is stored securely in our database and associated with your company. You can revoke notification permission at any time through your browser or device settings, or through the Constra Settings page. Revoking permission automatically removes your push subscription from our systems.`,
    },
    {
    ...
    {
      title: "8. Security",
      body: `We implement industry-standard security measures including encryption in transit (TLS) and at rest, row-level security policies ensuring your company's data is isolated from other tenants, and access controls that limit data access to authenticated users within your company. All API endpoints require authentication. No system is perfectly secure — report any suspected breach immediately.`,
    },
    {
      title: "9. Your Rights",
    ...
    {
      title: "10. Employee and Contractor Data",
    ...
    {
      title: "14. Contact Us",
      body: `For privacy-related questions, requests, or complaints, please contact us at hello@getconstra.com. We take all privacy concerns seriously and will respond within 30 days.`,
    },
  ];
